...
def main(mode=None):
    ...
    if torch.cuda.is_available():
        ...
        try:
            ...
            print(f"Using XLA/TPU device {config.DEVICE}.")
        except:
...
def load_config(mode=None):
    ...
    parser.add_argument('--tpu', type=str, help='machine to run segmentation model on')
    ...
    config.SEG_DEVICE = 'cpu' if args.cpu is not None else (xm.xla_device() if args.tpu is not None else 'cuda')
